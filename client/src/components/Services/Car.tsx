...
const Car:FC<any> = ({type, title , text , id , price , img}) => {
  return (
    <li className='mb-10 max-w-[30%] '>
        <input type="radio" id={type+id} name="hosting" value={id} className="hidden peer" required />
